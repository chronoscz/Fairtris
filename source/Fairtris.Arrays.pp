...
const
  SETTINGS_VALUE_KEYBOARD: array [DEVICE_FIRST .. DEVICE_LAST] of Integer = (
    SETTINGS_VALUE_KEYBOARD_UP,
    SETTINGS_VALUE_KEYBOARD_DOWN,
    SETTINGS_VALUE_KEYBOARD_LEFT,
    SETTINGS_VALUE_KEYBOARD_RIGHT,
    SETTINGS_VALUE_KEYBOARD_SELECT,
    SETTINGS_VALUE_KEYBOARD_START,
    SETTINGS_VALUE_KEYBOARD_B,
    SETTINGS_VALUE_KEYBOARD_A
  );

  SETTINGS_VALUE_CONTROLLER: array [DEVICE_FIRST .. DEVICE_LAST] of Integer = (
    SETTINGS_VALUE_CONTROLLER_UP,
    SETTINGS_VALUE_CONTROLLER_DOWN,
    SETTINGS_VALUE_CONTROLLER_LEFT,
    SETTINGS_VALUE_CONTROLLER_RIGHT,
    SETTINGS_VALUE_CONTROLLER_SELECT,
    SETTINGS_VALUE_CONTROLLER_START,
    SETTINGS_VALUE_CONTROLLER_B,
    SETTINGS_VALUE_CONTROLLER_A
  );
