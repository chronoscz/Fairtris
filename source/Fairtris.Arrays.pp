...
const
  KEYBOARD_KEY_LOCKED: set of UInt8 = [
    KEYBOARD_SCANCODE_KEY_FIXED_HELP_UNDERSTAND,
    KEYBOARD_SCANCODE_KEY_FIXED_HELP_CONTROL,
    KEYBOARD_SCANCODE_KEY_FIXED_TOGGLE_CLIP,
...
const
  ITEM_TEXT_PLAY: array [ITEM_PLAY_FIRST .. ITEM_PLAY_LAST] of String = (
    ...
    ITEM_TEXT_PLAY_GENERATOR_TITLE,
