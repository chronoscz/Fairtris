...
const
  FAIR_BAGS: array [FAIR_BAGS_FIRST .. FAIR_BAGS_LAST] of array [FAIR_BAGS_PIECE_FIRST .. FAIR_BAGS_PIECE_LAST] of Integer = (
    ...
    (PIECE_T, PIECE_J, PIECE_Z, PIECE_O, PIECE_S, PIECE_L, PIECE_I,   PIECE_O, PIECE_T),
    (PIECE_T, PIECE_J, PIECE_Z, PIECE_O, PIECE_S, PIECE_L, PIECE_I,   PIECE_S, PIECE_Z),
    (PIECE_T, PIECE_J, PIECE_Z, PIECE_O, PIECE_S, PIECE_L, PIECE_I,   PIECE_L, PIECE_J),
