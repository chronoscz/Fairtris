...
const
  BEST_SCORES_COLOR_FILLED: array [THEME_FIRST .. THEME_LAST] of Integer = (COLOR_GRAY, COLOR_WHITE);
  BEST_SCORES_COLOR_EMPTY:  array [THEME_FIRST .. THEME_LAST] of Integer = (COLOR_DARK, COLOR_DARK);
