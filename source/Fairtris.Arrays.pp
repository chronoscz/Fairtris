...
const
  ITEM_X_SINGLE_PLAYER: array [ITEM_SINGLE_PLAYER_FIRST .. ITEM_SINGLE_PLAYER_LAST] of Integer = (
    ITEM_X_SINGLE_PLAYER_REGION,
    ITEM_X_SINGLE_PLAYER_GENERATOR,
    ITEM_X_SINGLE_PLAYER_LEVEL,
    ITEM_X_SINGLE_PLAYER_START,
    ITEM_X_SINGLE_PLAYER_BACK
  );
...
const
  ITEM_Y_SINGLE_PLAYER: array [ITEM_SINGLE_PLAYER_FIRST .. ITEM_SINGLE_PLAYER_LAST] of Integer = (
    ...
    ITEM_Y_SINGLE_PLAYER_BACK
  );

  ITEM_Y_SINGLE_PLAYER_BEST_SCORES: array [THEME_FIRST .. THEME_LAST] of Integer = (
    ITEM_Y_SINGLE_PLAYER_BEST_SCORES_MODERN,
    ITEM_Y_SINGLE_PLAYER_BEST_SCORES_CLASSIC
  );
...
const
  ITEM_TEXT_CORE_REGION: array [REGION_FIRST .. REGION_LAST] of String = (
    ITEM_TEXT_CORE_REGION_NTSC,
    ITEM_TEXT_CORE_REGION_NTSC_EXTENDED,
    ITEM_TEXT_CORE_REGION_JPN,
    ITEM_TEXT_CORE_REGION_JPN_EXTENDED,
    ITEM_TEXT_CORE_REGION_PAL,
    ITEM_TEXT_CORE_REGION_PAL_EXTENDED,
    ITEM_TEXT_CORE_REGION_EUR,
    ITEM_TEXT_CORE_REGION_EUR_EXTENDED
  );

  ITEM_TEXT_CORE_GENERATOR: array [GENERATOR_FIRST .. GENERATOR_LAST] of String = (
    ITEM_TEXT_CORE_GENERATOR_7_BAG,
    ITEM_TEXT_CORE_GENERATOR_MULTIBAG,
    ITEM_TEXT_CORE_GENERATOR_CLASSIC,
    ITEM_TEXT_CORE_GENERATOR_BALANCED,
    ITEM_TEXT_CORE_GENERATOR_TGM,
    ITEM_TEXT_CORE_GENERATOR_TGM3,
    ITEM_TEXT_CORE_GENERATOR_UNFAIR
  );

const
  ITEM_TEXT_SINGLE_PLAYER: array [ITEM_SINGLE_PLAYER_FIRST .. ITEM_SINGLE_PLAYER_LAST] of String = (
    ITEM_TEXT_SINGLE_PLAYER_REGION_TITLE,
    ITEM_TEXT_SINGLE_PLAYER_GENERATOR_TITLE,
    ITEM_TEXT_SINGLE_PLAYER_LEVEL,
    ITEM_TEXT_SINGLE_PLAYER_START,
    ITEM_TEXT_SINGLE_PLAYER_BACK
  );
