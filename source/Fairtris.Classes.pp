{
  ...
  This unit is part of the "Fairtris" video game source code. It mainly
  contains base and universal classes used to store information about
  many elements of game scenes.
