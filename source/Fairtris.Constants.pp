...
const
  ...
  ERROR_SDL_CREATE_WINDOW      = 1;
  ERROR_SDL_CREATE_RENDERER    = 2;
  ERROR_SDL_CREATE_HANDLE      = 3;
  ERROR_SDL_CREATE_BACK_BUFFER = 4;
  ERROR_SDL_CREATE_QUIT_BUFFER = 5;

  ERROR_SDL_LOAD_SPRITE = 6;
  ERROR_SDL_LOAD_GROUND = 7;
  ERROR_SDL_LOAD_SOUND  = 8;
