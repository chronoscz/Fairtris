...
const
  ...
  KEYBOARD_SCANCODE_KEY_NOT_MAPPED      = 0;
  KEYBOARD_SCANCODE_KEY_HELP_UNDERSTAND = VK_F1;
  KEYBOARD_SCANCODE_KEY_HELP_CONTROL    = VK_F2;
  KEYBOARD_SCANCODE_KEY_CLEAR_MAPPING   = VK_BACK;
...
const
  PIECE_ORIENTATION_T_DOWN  = 0;
  PIECE_ORIENTATION_T_LEFT  = 1;
  PIECE_ORIENTATION_T_UP    = 2;
  PIECE_ORIENTATION_T_RIGHT = 3;

  PIECE_ORIENTATION_T_FIRST = PIECE_ORIENTATION_T_DOWN;
  PIECE_ORIENTATION_T_LAST  = PIECE_ORIENTATION_T_RIGHT;

  PIECE_ORIENTATION_T_COUNT = PIECE_ORIENTATION_T_LAST + 1;
  PIECE_ORIENTATION_T_SPAWN = PIECE_ORIENTATION_T_FIRST;

const
  PIECE_ORIENTATION_J_DOWN  = 0;
  PIECE_ORIENTATION_J_LEFT  = 1;
  PIECE_ORIENTATION_J_UP    = 2;
  PIECE_ORIENTATION_J_RIGHT = 3;

  PIECE_ORIENTATION_J_FIRST = PIECE_ORIENTATION_J_DOWN;
  PIECE_ORIENTATION_J_LAST  = PIECE_ORIENTATION_J_RIGHT;

  PIECE_ORIENTATION_J_COUNT = PIECE_ORIENTATION_J_LAST + 1;
  PIECE_ORIENTATION_J_SPAWN = PIECE_ORIENTATION_J_FIRST;

const
  PIECE_ORIENTATION_Z_HORZ = 0;
  PIECE_ORIENTATION_Z_VERT = 1;

  PIECE_ORIENTATION_Z_FIRST = PIECE_ORIENTATION_Z_HORZ;
  PIECE_ORIENTATION_Z_LAST  = PIECE_ORIENTATION_Z_VERT;

  PIECE_ORIENTATION_Z_COUNT = PIECE_ORIENTATION_Z_LAST + 1;
  PIECE_ORIENTATION_Z_SPAWN = PIECE_ORIENTATION_Z_FIRST;

const
  PIECE_ORIENTATION_O = 0;

  PIECE_ORIENTATION_O_FIRST = PIECE_ORIENTATION_O;
  PIECE_ORIENTATION_O_LAST  = PIECE_ORIENTATION_O;

  PIECE_ORIENTATION_O_COUNT = PIECE_ORIENTATION_O_LAST + 1;
  PIECE_ORIENTATION_O_SPAWN = PIECE_ORIENTATION_O;

const
  PIECE_ORIENTATION_S_HORZ = 0;
  PIECE_ORIENTATION_S_VERT = 1;

  PIECE_ORIENTATION_S_FIRST = PIECE_ORIENTATION_S_HORZ;
  PIECE_ORIENTATION_S_LAST  = PIECE_ORIENTATION_S_VERT;

  PIECE_ORIENTATION_S_COUNT = PIECE_ORIENTATION_S_LAST + 1;
  PIECE_ORIENTATION_S_SPAWN = PIECE_ORIENTATION_S_FIRST;

const
  PIECE_ORIENTATION_L_DOWN  = 0;
  PIECE_ORIENTATION_L_LEFT  = 1;
  PIECE_ORIENTATION_L_UP    = 2;
  PIECE_ORIENTATION_L_RIGHT = 3;

  PIECE_ORIENTATION_L_FIRST = PIECE_ORIENTATION_L_DOWN;
  PIECE_ORIENTATION_L_LAST  = PIECE_ORIENTATION_L_RIGHT;

  PIECE_ORIENTATION_L_COUNT = PIECE_ORIENTATION_L_LAST + 1;
  PIECE_ORIENTATION_L_SPAWN = PIECE_ORIENTATION_L_FIRST;

const
  PIECE_ORIENTATION_I_HORZ = 0;
  PIECE_ORIENTATION_I_VERT = 1;

  PIECE_ORIENTATION_I_FIRST = PIECE_ORIENTATION_I_HORZ;
  PIECE_ORIENTATION_I_LAST  = PIECE_ORIENTATION_I_VERT;

  PIECE_ORIENTATION_I_COUNT = PIECE_ORIENTATION_I_LAST + 1;
  PIECE_ORIENTATION_I_SPAWN = PIECE_ORIENTATION_I_FIRST;
...
const
  SETTINGS_KEY_GENERAL_FRAMERATE = 'FRAMERATE';
