...
const
  ...
  KEYBOARD_KEY_FIXED_HELP_UNDERSTAND = 7;
  KEYBOARD_KEY_FIXED_HELP_CONTROL    = 8;
  KEYBOARD_KEY_FIXED_TOGGLE_CLIP     = 9;
  KEYBOARD_KEY_FIXED_TOGGLE_VIDEO    = 10;

  KEYBOARD_KEY_FIXED_FIRST = KEYBOARD_KEY_FIXED_UP;
  KEYBOARD_KEY_FIXED_LAST  = KEYBOARD_KEY_FIXED_TOGGLE_VIDEO;
...
const
  ...
  KEYBOARD_SCANCODE_KEY_FIXED_HELP_UNDERSTAND = SDL_SCANCODE_F1;
  KEYBOARD_SCANCODE_KEY_FIXED_HELP_CONTROL    = SDL_SCANCODE_F2;
  KEYBOARD_SCANCODE_KEY_FIXED_TOGGLE_CLIP     = SDL_SCANCODE_F10;
