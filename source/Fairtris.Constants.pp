...
const
  ITEM_MODES_SINGLE_PLAYER    = 0;
  ITEM_MODES_TOURNAMENT_QUALS = 1;
  ITEM_MODES_TOURNAMENT_MATCH = 2;
  ITEM_MODES_SPEEDRUN_QUALS   = 3;
  ITEM_MODES_SPEEDRUN_MATCH   = 4;
  ITEM_MODES_BACK             = 5;

  ITEM_MODES_FIRST = ITEM_MODES_SINGLE_PLAYER;
  ITEM_MODES_LAST  = ITEM_MODES_BACK;

  ITEM_MODES_COUNT = ITEM_MODES_LAST + 1;

const
  ITEM_SINGLE_PLAYER_REGION    = 0;
  ITEM_SINGLE_PLAYER_GENERATOR = 1;
  ITEM_SINGLE_PLAYER_LEVEL     = 2;
  ITEM_SINGLE_PLAYER_START     = 3;
  ITEM_SINGLE_PLAYER_BACK      = 4;

  ITEM_SINGLE_PLAYER_FIRST = ITEM_SINGLE_PLAYER_REGION;
  ITEM_SINGLE_PLAYER_LAST  = ITEM_SINGLE_PLAYER_BACK;

  ITEM_SINGLE_PLAYER_COUNT = ITEM_SINGLE_PLAYER_LAST + 1;

const
  ITEM_TOURNAMENT_QUALS_REGION    = 0;
  ITEM_TOURNAMENT_QUALS_GENERATOR = 1;
  ITEM_TOURNAMENT_QUALS_LEVEL     = 2;
  ITEM_TOURNAMENT_QUALS_START     = 3;
  ITEM_TOURNAMENT_QUALS_BACK      = 4;

  ITEM_TOURNAMENT_QUALS_FIRST = ITEM_TOURNAMENT_QUALS_REGION;
  ITEM_TOURNAMENT_QUALS_LAST  = ITEM_TOURNAMENT_QUALS_BACK;

  ITEM_TOURNAMENT_QUALS_COUNT = ITEM_TOURNAMENT_QUALS_LAST + 1;

const
  ITEM_TOURNAMENT_MATCH_REGION    = 0;
  ITEM_TOURNAMENT_MATCH_GENERATOR = 1;
  ITEM_TOURNAMENT_MATCH_LEVEL     = 2;
  ITEM_TOURNAMENT_MATCH_START     = 3;
  ITEM_TOURNAMENT_MATCH_BACK      = 4;

  ITEM_TOURNAMENT_MATCH_FIRST = ITEM_TOURNAMENT_MATCH_REGION;
  ITEM_TOURNAMENT_MATCH_LAST  = ITEM_TOURNAMENT_MATCH_BACK;

  ITEM_TOURNAMENT_MATCH_COUNT = ITEM_TOURNAMENT_MATCH_LAST + 1;
...
const
  ...
  ITEM_X_MODES_SINGLE_PLAYER    = 64;
  ITEM_X_MODES_TOURNAMENT_QUALS = 64;
  ITEM_X_MODES_TOURNAMENT_MATCH = 64;
  ITEM_X_MODES_SPEEDRUN_QUALS   = 64;
  ITEM_X_MODES_SPEEDRUN_MATCH   = 64;
  ITEM_X_MODES_BACK             = 64;

  ITEM_X_SINGLE_PLAYER_REGION     = 32;
  ITEM_X_SINGLE_PLAYER_GENERATOR  = 32;
  ITEM_X_SINGLE_PLAYER_LEVEL      = 32;
  ITEM_X_SINGLE_PLAYER_START      = 32;
  ITEM_X_SINGLE_PLAYER_BACK       = 32;
  ITEM_X_SINGLE_PLAYER_BEST_SCORE = 32;
  ITEM_X_SINGLE_PLAYER_PARAM      = 120;
...
const
  ...
  ITEM_Y_MODES_SINGLE_PLAYER    = 72;
  ITEM_Y_MODES_TOURNAMENT_QUALS = 92;
  ITEM_Y_MODES_TOURNAMENT_MATCH = 104;
  ITEM_Y_MODES_SPEEDRUN_QUALS   = 124;
  ITEM_Y_MODES_SPEEDRUN_MATCH   = 136;
  ITEM_Y_MODES_BACK             = 156;

  ITEM_Y_SINGLE_PLAYER_REGION    = 56;
  ITEM_Y_SINGLE_PLAYER_GENERATOR = 68;
  ITEM_Y_SINGLE_PLAYER_LEVEL     = 80;
  ITEM_Y_SINGLE_PLAYER_START     = 100;
  ITEM_Y_SINGLE_PLAYER_BACK      = 112;

  ITEM_Y_SINGLE_PLAYER_BEST_SCORES_MODERN  = 140;
  ITEM_Y_SINGLE_PLAYER_BEST_SCORES_CLASSIC = 142;
...
const
  ...
  ITEM_TEXT_MODES_SINGLE_PLAYER    = 'SINGLE PLAYER';
  ITEM_TEXT_MODES_TOURNAMENT_QUALS = 'TOURNAMENT QUALS';
  ITEM_TEXT_MODES_TOURNAMENT_MATCH = 'TOURNAMENT MATCH';
  ITEM_TEXT_MODES_SPEEDRUN_QUALS   = 'SPEEDRUN QUALS';
  ITEM_TEXT_MODES_SPEEDRUN_MATCH   = 'SPEEDRUN MATCH';
  ITEM_TEXT_MODES_BACK             = 'BACK';

  ITEM_TEXT_CORE_REGION_NTSC          = 'NTSC';
  ITEM_TEXT_CORE_REGION_NTSC_EXTENDED = 'NTSC EXTENDED';
  ITEM_TEXT_CORE_REGION_JPN           = 'JPN';
  ITEM_TEXT_CORE_REGION_JPN_EXTENDED  = 'JPN EXTENDED';
  ITEM_TEXT_CORE_REGION_PAL           = 'PAL';
  ITEM_TEXT_CORE_REGION_PAL_EXTENDED  = 'PAL EXTENDED ';
  ITEM_TEXT_CORE_REGION_EUR           = 'EUR';
  ITEM_TEXT_CORE_REGION_EUR_EXTENDED  = 'EUR EXTENDED ';

  ITEM_TEXT_CORE_GENERATOR_7_BAG    = '7-BAG';
  ITEM_TEXT_CORE_GENERATOR_MULTIBAG = 'MULTI-BAG';
  ITEM_TEXT_CORE_GENERATOR_CLASSIC  = 'CLASSIC';
  ITEM_TEXT_CORE_GENERATOR_BALANCED = 'BALANCED';
  ITEM_TEXT_CORE_GENERATOR_TGM      = 'TGM';
  ITEM_TEXT_CORE_GENERATOR_TGM3     = 'TGM TERROR';
  ITEM_TEXT_CORE_GENERATOR_UNFAIR   = 'UNFAIR';

  ITEM_TEXT_SINGLE_PLAYER_REGION_TITLE    = 'REGION';
  ITEM_TEXT_SINGLE_PLAYER_GENERATOR_TITLE = 'RNG TYPE';
  ITEM_TEXT_SINGLE_PLAYER_LEVEL           = 'LEVEL';
  ITEM_TEXT_SINGLE_PLAYER_START           = 'START';
  ITEM_TEXT_SINGLE_PLAYER_BACK            = 'BACK';
...
const
  BALANCED_FLOOD_COUNT_PIECE   = 3;
  BALANCED_FLOOD_COUNT_LONGBAR = 4;

const
  BALANCED_DROUGHT_COUNT = 13;
