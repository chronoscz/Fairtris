...
const
  ...
  MODE_TOURNAMENT_QUALS = 1;
  MODE_TOURNAMENT_MATCH = 2;
  MODE_SPEEDRUN_QUALS   = 3;
  MODE_SPEEDRUN_MATCH   = 4;

  MODE_DEFAULT = MODE_SINGLE_PLAYER;
...
const
  ...
  LEVEL_LAST_SINGLE_NTSC = 29;
  LEVEL_LAST_SINGLE_PAL  = 19;

  LEVEL_COUNT_QUALS_NTSC = LEVEL_LAST_QUALS_NTSC + 1;
  LEVEL_COUNT_QUALS_PAL  = LEVEL_LAST_QUALS_PAL  + 1;

  LEVEL_COUNT_SINGLE_NTSC = LEVEL_LAST_SINGLE_NTSC + 1;
  LEVEL_COUNT_SINGLE_PAL  = LEVEL_LAST_SINGLE_PAL  + 1;
...
const
  ...
  KEYBOARD_KEY_FIXED_GENERATE     = 8;
  KEYBOARD_KEY_FIXED_TOGGLE_VIDEO = 9;
  KEYBOARD_KEY_FIXED_TOGGLE_THEME = 10;
...
const
  ...
  KEYBOARD_SCANCODE_KEY_FIXED_GENERATE     = SDL_SCANCODE_F5;
