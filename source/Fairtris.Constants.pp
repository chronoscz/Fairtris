...
const
  ...
  ERROR_SDL_CREATE_WINDOW      = 2;
  ERROR_SDL_CREATE_RENDERER    = 3;
  ERROR_SDL_CREATE_HANDLE      = 4;
  ERROR_SDL_CREATE_BACK_BUFFER = 5;
  ERROR_SDL_CREATE_QUIT_BUFFER = 6;

  ERROR_SDL_LOAD_SPRITE = 7;
  ERROR_SDL_LOAD_GROUND = 8;
  ERROR_SDL_LOAD_SOUND  = 9;
...
const
  WARNING_SDL_HINT_MINIMIZING = 0;
  WARNING_SDL_HINT_QUALITY    = 1;
