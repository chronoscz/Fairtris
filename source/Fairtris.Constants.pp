...
const
  PIECE_ROTATION_COUNTERCLOCKWISE = 0;
  PIECE_ROTATION_CLOCKWISE        = 1;

  PIECE_ROTATION_FIRST = PIECE_ROTATION_COUNTERCLOCKWISE;
  PIECE_ROTATION_LAST  = PIECE_ROTATION_CLOCKWISE;

  PIECE_ROTATION_COUNT = PIECE_ROTATION_LAST + 1;
