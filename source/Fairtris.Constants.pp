...
const
  ...
  CONTROLLER_SCANCODE_ARROW_X_NEGATIVE = CONTROLLER_ARROWS_OFFSET + 0;
  CONTROLLER_SCANCODE_ARROW_X_POSITIVE = CONTROLLER_ARROWS_OFFSET + 1;
  CONTROLLER_SCANCODE_ARROW_Y_NEGATIVE = CONTROLLER_ARROWS_OFFSET + 2;
  CONTROLLER_SCANCODE_ARROW_Y_POSITIVE = CONTROLLER_ARROWS_OFFSET + 3;
  CONTROLLER_SCANCODE_ARROW_Z_NEGATIVE = CONTROLLER_ARROWS_OFFSET + 4;
  CONTROLLER_SCANCODE_ARROW_Z_POSITIVE = CONTROLLER_ARROWS_OFFSET + 5;
  CONTROLLER_SCANCODE_ARROW_R_NEGATIVE = CONTROLLER_ARROWS_OFFSET + 6;
  CONTROLLER_SCANCODE_ARROW_R_POSITIVE = CONTROLLER_ARROWS_OFFSET + 7;
  CONTROLLER_SCANCODE_ARROW_U_NEGATIVE = CONTROLLER_ARROWS_OFFSET + 8;
  CONTROLLER_SCANCODE_ARROW_U_POSITIVE = CONTROLLER_ARROWS_OFFSET + 9;
  CONTROLLER_SCANCODE_ARROW_V_NEGATIVE = CONTROLLER_ARROWS_OFFSET + 10;
  CONTROLLER_SCANCODE_ARROW_V_POSITIVE = CONTROLLER_ARROWS_OFFSET + 11;

  CONTROLLER_SCANCODE_BUTTON_FIRST = CONTROLLER_SCANCODE_BUTTON_0;
  CONTROLLER_SCANCODE_BUTTON_LAST  = CONTROLLER_SCANCODE_ARROW_V_POSITIVE;

  CONTROLLER_SCANCODE_BUTTON_NOT_MAPPED = CONTROLLER_SCANCODE_BUTTON_LAST + 1;

  CONTROLLER_SCANCODE_BUTTON_UP     = CONTROLLER_SCANCODE_ARROW_Y_NEGATIVE;
  CONTROLLER_SCANCODE_BUTTON_DOWN   = CONTROLLER_SCANCODE_ARROW_Y_POSITIVE;
  CONTROLLER_SCANCODE_BUTTON_LEFT   = CONTROLLER_SCANCODE_ARROW_X_NEGATIVE;
  CONTROLLER_SCANCODE_BUTTON_RIGHT  = CONTROLLER_SCANCODE_ARROW_X_POSITIVE;
