...
type
  ...
  public
    ...
    property Generate: TSwitch index KEYBOARD_KEY_FIXED_GENERATE read GetKey;
  public
...
begin
  ...
  FKeys[KEYBOARD_KEY_FIXED_GENERATE].Pressed := AKeyboard.Device[KEYBOARD_SCANCODE_KEY_FIXED_GENERATE].Pressed;
